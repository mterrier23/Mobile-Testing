...
namespace FirstUITest
{
    public abstract class BasePage
    {
        ...
        // if you're sharing code in each page, you can add it here!! ex:
       
        public BasePage SelectMenuItem()
        {
            app.SwipeRightToLeft();
            app.WaitForElement(x => x.Marked("Settings").Index(1));
            app.Tap(x => x.Marked("Settings").Index(1));
            return this;
        }
